...
const DESKTOP_COMMANDS: &[&str] = &[
    ...
    "desktop_get_jp_rates",
    "desktop_save_jp_rate",
    "desktop_delete_jp_rate",
    ...
    "desktop_get_lesson_periods",
    "desktop_save_lesson_period",
    "desktop_delete_lesson_period",
    "desktop_get_jp_settings",
