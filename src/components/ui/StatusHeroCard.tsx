...
export function StatusHeroCard({
  ...
  return (
    <section
      ...
      className="relative overflow-hidden w-full rounded-2xl border border-blue-900/40 bg-gradient-to-br from-[#003399] via-[#002266] to-[#0a183d] text-white p-5 md:p-6 shadow-card-bca"
    >
      ...
      <div className="relative z-10 flex flex-wrap items-center justify-between gap-2 pb-4 border-b border-white/10">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex size-8 items-center justify-center rounded-lg bg-white/10 hover:bg-white/20 active:scale-95 text-white transition-all disabled:opacity-50"
          >
            <Icon
              name="sync"
              className={`size-4 ${isSyncing ? "animate-spin text-sky-300" : ""}`}
            />
          </button>
        </div>
      </div>
      ...
      <div className="relative z-10 mt-5 flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <span className="text-xs font-bold uppercase tracking-wider text-sky-200/80">
            Tingkat Kehadiran Hari Ini
          </span>
          <div className="flex items-baseline gap-2 mt-1">
            <span className="text-4xl md:text-5xl font-extrabold tracking-tight font-mono-data text-white">
        ...
        <div className="w-full md:w-56 space-y-1.5">
          <div className="flex justify-between text-xs font-semibold">
            <span className="text-sky-200">Total Masuk</span>
            <span className="font-mono-data text-white">
              {hadir} / {total} Orang
            </span>
          </div>
          <div className="h-2.5 w-full overflow-hidden rounded-full bg-black/30 border border-white/10">
            <div
      ...
      <div className="relative z-10 mt-5 grid grid-cols-3 gap-2.5">
        <div className="flex flex-col rounded-xl bg-white/10 backdrop-blur-md p-3 border border-white/10">
          ...
          <span className="text-xl md:text-2xl font-bold font-mono-data text-white mt-0.5">
            {tepatWaktu}
          </span>
        </div>
